# Challenge Name : What Algo?


> **1-ээс 9 оронтой N тоо хүртэлх тоонуудын нийлбэрийг 1 секундын дотор серверлүү илгээнэ. Хурдан compile хийх чадвартай хэл дээр бичвэл амжих байх, python дээр numpy эсвэл Gauss-ын томъёогоор бодож болно. 1**
